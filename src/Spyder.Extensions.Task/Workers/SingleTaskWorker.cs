    ...
    public abstract class SingleTaskWorker
    {
        ...
        public bool IsRunning
        {
            ...
            set
            {
                ...
                {
                    // Stop
                    System.Threading.Tasks.Task.Run(async () => await StopAsync()
        ...
        protected void RunWorkerTaskNoAwait()
        {
            ...
            System.Threading.Tasks.Task.Run(async () =>
            {
                ...
                catch (Exception exception)
                {
                    ...
                    Logger.LogCriticalSource($"Unhandled exception in {nameof(SingleTaskWorker)},'{WorkerName}'",
                                             exception: exception);
                }
                finally
                {
        ...
        protected virtual System.Threading.Tasks.Task WorkerTaskAsync(CancellationToken cancellationToken)
        {
